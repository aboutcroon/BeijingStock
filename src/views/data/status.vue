  ...
  <div class="right_cont">
    <div class="boya-view">
      ...
      <el-table
        ...
        <el-table-column prop="tx" label="交易哈希" show-overflow-tooltip></el-table-column>
        <el-table-column prop="block" label="区块号" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column label="操作" show-overflow-tooltip>
          <template slot-scope="scope">
            ...
            <span @click="upload(scope.$index, scope.row)" style="color:#8794ae" v-show="scope.row.onblock"  class="icon iconfont iconupload"></span>
            ...
            <span @click="doDelete(scope.$index, scope.row)" style="color:#BF495A" v-show="scope.row.onblock" class="icon iconfont icondelete"></span>
          </template>
        </el-table-column>
      </el-table>
      <div class="float-btn">
