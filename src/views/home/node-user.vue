<template>
  <div class="boya-view" style="min-height: calc(100vh - 116px); margin-top: 0; background-color: #ffffff; padding-bottom: 60px">
    <el-row style="width:100%;padding-top: 20px">
      <el-col :span="24">
        <div class="home-main-input" style="width: 386px">
          <Input v-model="value" placeholder="请输入用户名/机构名称">
    ...
    <el-table
      class="boya-table"
      :data="tableData"
      style="width: 100%;clear:both;margin-top:20px;margin-bottom: 20px;"
      ...
      <div class="drawer-main boya-scrollbar">
        <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" label-position="top">
          ...
          <Form-item label="确认密码" prop="confirm_password">
            <Input v-model="formValidate.confirm_password" placeholder="请输入密码" type="password" autocomplete="new-password" />
          </Form-item>
          ...
          <Form-item label="状态" prop="status">
            <Radio-group v-model="formValidate.status" vertical>
    ...
    >
      ...
      <div class="drawer-main boya-scrollbar">
        <Form ref="formValidate" :model="forms" :rules="ruleValidate" label-position="top">
          ...
          <Form-item label="状态" prop="status" vertical>
    ...
    methods: {
      ...
      checkData(data) {
        ...
        if(check1) {
          ...
          this.http.messageFun('error',"两次输入的密码不一致")
        }
