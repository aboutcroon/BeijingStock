    ...
    <el-row class="home-row">
      ...
      <el-col :span="24">
        <div class="home-block" style="height: 56px;padding: 8px 20px;">
          <Button class="btn-reset" style="margin-left: 5px" @click="handleClose">选项</Button>
          <div class="home-main-input" style=" margin-left: 14px;">
            <Input v-model="cont">
          ...
          <div style="display: inline-block;float: right;width: 300px;height: 40px;line-height: 40px;">
            <el-row class="font">
              <el-col v-for="item in title" :key="item.title" :span="4" style="float: right"><span style="cursor: pointer;" @click="tojump($event)">{{ item.title }}</span></el-col>
            </el-row>
          </div>
        </div>
      </el-col>
