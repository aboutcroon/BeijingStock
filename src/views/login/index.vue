<template>
  <el-row class="login-container">
    <el-col :span="13" class="login-left">
      <img src="../../assets/img/blockchain_login@1x.png" srcset="../../assets/img/blockchain_login@2x.png 2x,../../assets/img/blockchain_login@3x.png 3x" class="login-img"/>
    </el-col>
    <el-col :span="11" class="login-right">
      <div class="login-logo">
        <img src="../../assets/img/logo.png" style="height: 44px;"/>
      </div>
      <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="top">
        ...
        <el-tooltip v-model="capsTooltip" content="大写锁定打开" placement="right" manual>
          <el-form-item prop="password"  label="密码" class="login-form-item">
            <div class="login-form-input">
              ...
              />
              <span class="show-pwd icon iconfont" @click="showPwd" :class="passwordType === 'password' ? 'iconicons8-visible' : 'iconicons8-visible_filled'">
          </span>
            </div>
        ...
        <el-button :loading="loading" type="primary" style="border: none;width:100%;margin-top:52px;clear: both;height: 50px;background: #EBEBF2; color: #3B3783" @click.native.prevent="handleLogin">登录</el-button>
        ...
        if (valid) {
          ...
          this.$store.dispatch('user/login', this.loginForm)
            .then((res) => {
              ...
              if (data == '3' || data == '4') {
                this.$router.push({ path: '/users/user', query: this.otherQuery })
                this.$router.go(0)
              } else if (data == '2' || data == '1') {
                this.$router.push({ path: '/users/admin', query: this.otherQuery })
              } else if (data == '0') {
