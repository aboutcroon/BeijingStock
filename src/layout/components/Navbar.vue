<template>
  <div class="navbar">
    <div class="left-menu2" v-if="isHome">
      <div class="nav-search2" v-if="!isSuperAdmin">
        <span class="iconfont iconsearch_all " style="margin-left: 27px;font-size: 18px;cursor: pointer;" @click="topquery"></span>
        <input class="transition-box bar_input" v-model="input" placeholder="交易哈希/区块号/标签" @keyup.enter="topquery()">
      </div>
    </div>
    <div class="left-menu" v-else="">
      ...
      <div class="nav-search" v-if="!isSuperAdmin">
        <span class="iconfont iconsearch_all " style="margin-left: 27px;font-size: 18px;cursor: pointer;" @click="topquery"></span>
        <input class="transition-box bar_input" v-model="input" placeholder="交易哈希/区块号/标签" @keyup.enter="topquery()">
      </div>
    </div>
...
<!--        <error-log class="errLog-container right-menu-item hover-effect" />-->
      ...
      <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
        <div class="avatar-wrapper">
          ...
          <span class="iconfont iconadmin1"></span>
